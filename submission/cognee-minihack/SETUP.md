...
First, copy over the models director from the USB stick into the cognee-minihack directory. Then, navigate to the models directory containing the downloaded model files and the register the models with:
